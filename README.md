...
1. **RubiksCube3dArray** - 3D array representation (intuitive)
2. **RubiksCube1dArray** - Flattened 1D array (cache-friendly)
3. **RubiksCubeBitboard** - Bitwise representation (most optimized)
...
1. Creates a solved Rubik's Cube
2. Randomly scrambles it with 13 moves
3. Displays the scrambled state
4. Solves using IDA* algorithm
5. Shows the solution moves
